...
class Data_Desa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('dinpermasdes/desa/data_desa', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_dinpermasdes/header', $data);
        $this->load->view('template_dinpermasdes/sidebar');
        $this->load->view('dinpermasdes/desa/tambah_dataDesa', $data);
        $this->load->view('template_dinpermasdes/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('dinpermasdes/data_desa');
        }
    }
    ...
    public function update_data()
    {
        ...
        $this->load->view('template_dinpermasdes/header', $data);
        $this->load->view('template_dinpermasdes/sidebar');
        $this->load->view('dinpermasdes/desa/update_dataDesa', $data);
        $this->load->view('template_dinpermasdes/footer');
    }
