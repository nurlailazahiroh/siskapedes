...
class Data_Kecamatan extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('dinpermasdes/kecamatan/data_kecamatan', $data);
    ...
    public function tambah_data()
    {
        ...
        $this->load->view('template_dinpermasdes/header', $data);
        $this->load->view('template_dinpermasdes/sidebar');
        $this->load->view('dinpermasdes/kecamatan/tambah_dataKecamatan', $data);
        $this->load->view('template_dinpermasdes/footer');
    }
    ...
    public function tambah_data_aksi()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            redirect('dinpermasdes/data_kecamatan');
        }
    }
    ...
    public function update_data()
    {
        ...
        $this->load->view('template_dinpermasdes/header', $data);
        $this->load->view('template_dinpermasdes/sidebar');
        $this->load->view('dinpermasdes/kecamatan/update_dataKecamatan', $data);
        $this->load->view('template_dinpermasdes/footer');
    }
