...
<div class="card mx-auto" style="width: 60% ; margin-bottom: 100px">
    <div class="card-body">
        ...
        <?php foreach ($desa as $row) : ?>
            <form method="POST" action="<?php echo base_url('dinpermasdes/data_desa/update_data_aksi') ?>" enctype="multipart/form-data">
                <?= form_error(); ?>
                ...
                <a href="<?php echo base_url('dinpermasdes/desa/data_desa') ?>" class="btn btn-warning">Kembali</a>
