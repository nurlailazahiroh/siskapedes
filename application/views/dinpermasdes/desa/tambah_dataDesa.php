...
<div class="card mx-auto" style="width: 60% ; margin-bottom: 100px">
    <div class="card-body">
        <form method="POST" action="<?php echo base_url('dinpermasdes/data_desa/tambah_data_aksi') ?>" enctype="multipart/form-data">
            <?= form_error(); ?>
            ...
            <a href="<?php echo base_url('dinpermasdes/data_desa') ?>" class="btn btn-warning">Kembali</a>
