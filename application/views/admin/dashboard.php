              ...
              <div class="card border-left-info shadow py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Perangkat Desa</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $perangkat ?></div>
                    </div>
                    <div class="col-auto">
            ...
            <div class="col-xl-4 col-md-4 mb-4">
              <div class="card border-left-info shadow py-2">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">Jumlah Dinpermasdes</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $dinpermasdes ?></div>
                    </div>
                    <div class="col-auto">
                      <i class="fas fa-users fa-2x text-gray-300"></i>
                    </div>
